    ...
    return (
        <div className="flex items-center gap-4">
            ...
            <button
                ...
                className="px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600 rounded-full"
            >
                Select File
            </button>
            <button
                ...
                className="px-4 py-2 bg-green-500 text-white rounded hover:bg-green-600 rounded-full"
            >
